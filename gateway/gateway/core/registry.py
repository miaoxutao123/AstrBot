...
class AdapterRegistry:
    ...
    def discover(self, group: str = "agent_gateway.adapters") -> list[str]:
        ...
        Returns:
            Adapter type names registered during this call.

        Raises:
            TypeError: If an entry point does not expose a callable.
            ValueError: If a discovered type duplicates an existing factory.
        """
        ...
        for entry_point in selected:
            ...
            self.register_factory(entry_point.name, cast(AdapterFactory, factory))
