...
| Satori | `astrbot/core/platform/sources/satori/` | Core / protocol | P6 | `NOT_STARTED` | None | Not run | `4.27.4@0da69dd3` | Final large contract pressure test before API v1 freeze |
| QQ Official WebSocket | `astrbot/core/platform/sources/qqofficial/` | Core / protocol | Post-P6 | `NOT_STARTED` | None | Not run | `4.27.4@0da69dd3` | Distinct from webhook transport |
